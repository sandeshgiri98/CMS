                        ...
                        <div class="cart">
                            <div class="profileset">
                                ...
                                <div class="usertype" id="usertype-<?php echo $row['id']; ?>">
                                    ...
                                    <div class="userinfo" style="display: flex; gap: 5px;">
                                        <p style="color:blue">
                                            <span class="time-ago"
                                                data-datetime="<?php echo $row['complaint_datetime'] ?>"></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="counting">
                                <div class="like_count">
                                    <p><span id="like-count-<?php echo $row['id']; ?>">0</span> Likes</p>
                                </div>
                            </div>
                            ...
                            <div class="last-part">
                                <div class="heart_btn" id="love">
                                    <button class="add-to-cart heart-button" data-post-id="<?php echo $row['id']; ?>">
                                        <!-- <div class="content">
                                            <img class="heart">
                                        </div> -->
                                        <div class="heart-btn">
                                ...
                                <div class="button-container" id="comment">
                                    <button class="add-to-cart" onclick="commentPost(<?php echo $row['id']; ?>)">
