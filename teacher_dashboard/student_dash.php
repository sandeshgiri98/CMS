...
<body>
    ...
    ?>
            ...
            <div class="side-menu">
                <ul>
                    <li>
                        <a href="../teacher_dashboard/scontent.php">
                            <span class="las la-home"></span>
                            <small>Dashboard</small>
                        </a>
                    </li>
                    <li>
                        <a href="../profile_teacher/profile_setting.php">
                            <span class="las la-user-alt"></span>
                            <small>Profile</small>
                        </a>
                    </li>
                    <li>
                        <a href="../teacher_dashboard/make_complaint.php">
                            <span class="las la-envelope"></span>
                            <small>Make Complaint</small>
                        </a>
                    </li>
                    <li>
                        <a href="../teacher_dashboard/complaint_details.php">
                            <span class="las la-clipboard-list"></span>
                            <small>Complaint Details</small>
                        </a>
                    </li>
                    <li>
                        <a href="../teacher_dashboard/assigned_comp.php">
                            <span class="las la-tasks"></span>
                            <small>Assigned Complaint</small>
                        </a>
                    </li>
