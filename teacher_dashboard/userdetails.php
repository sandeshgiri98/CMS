            ...
            <div class="container">
                <table class="table">
                    ...
                    while ($row = mysqli_fetch_assoc($selectExe)) {
                        ...
                        <?php
                        $userId = $row['id'];
                        $rowHidden = $userId === $currentUserId ? 'hidden' : '';
                        ?>
                        <tr <?php echo $rowHidden; ?>>
                            ...
                            <td class="crude" style="display: flex; gap:10px;">
                                <button
                                    onclick="window.location.href='../crude/update.php?id=<?php echo $row['id'] ?>'">Update</button>
                                <?php
                                $deleteDisabled = $userId === $currentUserId ? 'disabled' : '';
                                ?>
                                <button class="delete-btn" data-id="<?php echo $userId; ?>" style="color: red"
                                    <?php echo $deleteDisabled; ?>
                                    onclick="deleteConfirmation(<?php echo $userId; ?>)">Delete</button>
                            </td>
                        </tr>
                        <?php
                    }
